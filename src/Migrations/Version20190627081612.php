 ...
 */
final class Version20190627081612 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment CHANGE conference_id conference_id INT DEFAULT NULL, CHANGE ref_note_id ref_note_id INT DEFAULT NULL');
    }
